use crate::meditations::meditations_config;
use crate::{
    categories::cagtegories_config, upload::route::upload_config, users::route::user_config,
};
...
pub fn guard_config(cfg: &mut web::ServiceConfig) {
    cfg.service(
        web::scope("")
            ...
            .configure(cagtegories_config)
            .configure(meditations_config)
